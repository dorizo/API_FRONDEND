            ...
            <div>
                ...
                >
                    ...
                    <Collapse in={checkedODC}>
                        <Grid container>
                            ...
                            <Grid item xs={9} md={9}>
                                <Item>
                                    <FormControl fullWidth size="small">
                                        <TextField id="fullWidth" size="small" />
                                    </FormControl>
                                </Item>
                            </Grid>
                        </Grid>
                        ...
                        <Grid container>
                            <Grid item xs={6} md={6}>
                                <Item>
                                    <FormControl fullWidth size="small">
                                        <TextField label="Long" id="fullWidth" size="small" />
                                    </FormControl>
                                </Item>
                            </Grid>
                            <Grid item xs={6} md={6}>
                                <Item>
                                    <FormControl fullWidth size="small">
                                        <TextField label="Lat" id="fullWidth" size="small" />
                                    </FormControl>
                                </Item>
                            </Grid>
                        </Grid>
                    ...
                    <Collapse in={buttonsimpan}>
                        <Button fullWidth variant="contained" endIcon={<GridSaveAltIcon />}>
                            Simpan
                        </Button>
                    </Collapse>
                </BottomSheet>
